...
contract Halo2VerifierReusable {
    ...
    uint256 internal constant INT_128_MAX =
    ...
    function verifyProof(
        ...
        returns (
            bool success,
            bytes32 vka_digest,
            int256[] memory rescaled_instances
        )
    {
        uint256 vka_length;
        assembly {
        ...
        assembly {
            ...
            for {
                ...
                for {
                    ...
                    for {
                        let j := instance_cptr
                    } lt(j, add(num_instances, instance_cptr)) {
                        j := add(j, 0x20)
                    } {
    ...
    function _verifyProof(
        ...
        assembly {
            ...
            function read_ec_point(success, proof_cptr, hash_mptr)
                -> ret0, ret1, ret2
            {
            ...
            function squeeze_challenge(vka_end, challenge_mptr, hash_mptr)
                -> ret0, ret1
            {
            ...
            function ec_add_acc(success, x, y) -> ret {
                ...
                ret := and(
                    success,
                    staticcall(gas(), 0x06, vka_end, 0x80, vka_end, 0x40)
                )
            }
            ...
            function ec_mul_acc(success, scalar) -> ret {
                ...
                ret := and(
                    success,
                    staticcall(gas(), 0x07, vka_end, 0x60, vka_end, 0x40)
                )
            }
            ...
            // Return updated (success).
            function ec_pairing(success, vka_end, lhs_x, lhs_y, rhs_x, rhs_y)
                -> ret
            {
                mstore(vka_end, lhs_x)
                mstore(add(0x20, vka_end), lhs_y)
                mstore(add(0x40, vka_end), mload(0x02a0))
                mstore(add(0x60, vka_end), mload(0x02c0))
                mstore(add(0x80, vka_end), mload(0x02e0))
                mstore(add(0xa0, vka_end), mload(0x0300))
                mstore(add(0xc0, vka_end), rhs_x)
                mstore(add(0xe0, vka_end), rhs_y)
                mstore(add(0x100, vka_end), mload(0x0320))
                mstore(add(0x120, vka_end), mload(0x0340))
                mstore(add(0x140, vka_end), mload(0x0360))
                mstore(add(0x160, vka_end), mload(0x0380))
                ret := and(
                    success,
                    staticcall(gas(), 0x08, vka_end, 0x180, vka_end, 0x20)
                )
                ...
                for {
                    ...
                    for {
                        ...
                        rhs := mulmod(
                            rhs,
                            addmod(
                                addmod(eval, mload(mload(0x40)), R),
                                gamma,
                                R
                            ),
                            R
                        ...
                        mstore(
                            mload(0x40),
                            mulmod(mload(mload(0x40)), DELTA, R)
                        )
                    }
            ...
            function z_evals(
                ...
                for {
                ...
                } lt(permutation_z_evals_ptr, perm_z_last_ptr) {
                    ...
                    quotient_eval_numer := addmod(
                        ...
                        mulmod(
                            l_0,
                            addmod(
                                calldataload(and(z_j, PTR_BITMASK)),
                                sub(
                                    R,
                                    calldataload(and(shr(32, z), PTR_BITMASK))
                                ),
                                R
                            ),
                            R
            ...
            function lookup_input_accum(expressions_word, fsmp, i, code_ptr)
                -> ret0, ret1, ret2
            {
                expressions_word := shr(8, expressions_word)
                // Number of words the mptr vars for the accumulator evaluations shifted up by one
                let num_words_vars := mul(
                    0x20,
                    and(expressions_word, BYTE_FLAG_BITMASK)
                )
                expressions_word := shr(8, expressions_word)
            ...
            function expression_evals_packed(fsmp, code_ptr, expressions_word)
                -> ret0, ret1, ret2
            {
                // Load in the least significant byte of the `expressions_word` word to get the total number of words we will need to load in.
                let num_words_shift_up_one := add(
                    mul(0x20, and(expressions_word, BYTE_FLAG_BITMASK)),
                    0x20
                )
                ...
                for {
                    ...
                    for {
                        ...
                        case 0x00 {
                            ...
                            mstore(
                                mstore_ptr,
                                calldataload(and(expressions_word, PTR_BITMASK))
                            )
                        ...
                        case 0x04 {
                            ret0, ret1, ret2 := lookup_input_accum(
                                expressions_word,
                                fsmp,
                                i,
                                code_ptr
            ...
            function lookup_expr_evals_packed(
                fsmp,
                code_ptr,
                expressions_word,
                mv
                ...
                ret0, ret1, ret2 := expression_evals_packed(
                    fsmp,
                    code_ptr,
                    expressions_word
                )
            ...
            function mv_lookup_evals(table, evals_ptr, quotient_eval_numer, y)
                -> ret0, ret1, ret2
            {
                ...
                for {
                    let j := add(0xa0, mload(0x40))
                } lt(j, add(outer_inputs_len, add(0xa0, mload(0x40)))) {
                    j := add(j, 0x20)
                } {
                ...
                default {
                    ...
                    for {
                        ...
                        for {
                            ...
                            tmp := mulmod(
                                tmp,
                                mload(add(j, add(0xa0, mload(0x40)))),
                                R
                            )
                        }
                ...
                rhs := addmod(
                    ...
                    sub(
                        R,
                        mulmod(
                            calldataload(and(shr(32, evals), PTR_BITMASK)),
                            tmp,
                            R
                        )
                    ),
                ...
                lhs := mulmod(
                    mulmod(table, tmp, R),
                    addmod(
                        calldataload(and(shr(16, evals), PTR_BITMASK)),
                        sub(R, calldataload(phi)),
                        R
                    ),
                    R
                )
            ...
            function lookup_evals(table, evals_ptr, quotient_eval_numer, y)
                -> ret0, ret1, ret2
            {
                // iterate through the input_tables_len
                let evals := mload(evals_ptr)
                ...
                // call the expression_evals function to evaluate the input_lines
                let input
                evals_ptr, input_expression, input := lookup_expr_evals_packed(
                    add(0xc0, mload(0x40)),
                    evals_ptr,
                    input_expression,
                    0x0
                    ...
                    mulmod(
                        ...
                        addmod(
                            mulmod(
                                ...
                                mulmod(
                                    addmod(
                                        calldataload(p_input),
                                        mload(add(0x80, mload(0x40))),
                                        R
                                    ),
                                    addmod(
                                        calldataload(p_table),
                                        mload(add(0xa0, mload(0x40))),
                                        R
                                    ),
                                    R
                                ),
            ...
            function coeff_computations(coeff_len_data, coeff_data) -> ret {
                ...
                case 0x01 {
                    ...
                    mstore(
                        add(and(shr(16, coeff_data), PTR_BITMASK), mload(0x40)),
                        mod(
                            mload(
                                add(and(coeff_data, PTR_BITMASK), mload(0x40))
                            ),
                            R
                        )
                    )
                ...
                default {
                    ...
                    for {
                        ...
                        let point_i := mload(
                            add(
                                and(shr(offset_base, coeff_data), PTR_BITMASK),
                                mload(0x40)
                            )
                        )
                        for {
            ...
            function single_rot_set(
                ...
                r_eval := addmod(
                    ...
                    mulmod(
                        coeff,
                        calldataload(and(r_evals_data, PTR_BITMASK)),
                        R
                    ),
                    R
                )
            ...
            function pairing_input_computations_first(
                len,
                pcs_ptr,
                data,
                theta_mptr,
                ...
                mstore(
                    add(0x20, mload(0x40)),
                    calldataload(and(data, PTR_BITMASK))
                )
                data := shr(16, data)
                for {
                    let i := 0
                    ...
                    for {
                        ...
                        default {
                            ...
                            case 0x00 {
                                ...
                                success := ec_add_acc(
                                    success,
                                    mload(and(data, PTR_BITMASK)),
                                    mload(and(shr(16, data), PTR_BITMASK))
                                )
                                if eq(comm_len, 0x02) {
                                    data := shr(32, data)
                                    success := ec_mul_acc(
                            ...
                            case 0x02 {
                                ...
                                success := ec_add_acc(
                                    success,
                                    mload(add(theta_mptr, 0x260)),
                                    mload(add(theta_mptr, 0x280))
                                )
                            }
                        }
                    }
            ...
            function pairing_input_computations(
                len,
                pcs_ptr,
                data,
                theta_mptr,
            ...
            let vka_end := 0x0
            {
                ...
                mstore(vka_end, mload(0xa0))

                // Read instances and witness commitments and generate challenges
                let hash_mptr := add(0x20, vka_end)

                let proof_cptr := proof.offset
                let challenge_mptr := add(vka_end, mload(192)) // challenge mptr starts at vka_end + fsm
                ...
                let num_evals := mul(0x20, mload(0x0100))
                ...
                for {
                    ...
                    for {
                        ...
                        let proof_cptr_end := add(
                            proof_cptr,
                            and(challenge_len_data, PTR_BITMASK)
                        )
                        ...
                        for {
                            ...
                            challenge_mptr := squeeze_challenge_cont(
                                vka_end,
                                challenge_mptr
                            )
                        }
                ...
                // Read evaluations
                for {
                    let proof_cptr_end := add(proof_cptr, num_evals)
                } lt(proof_cptr, proof_cptr_end) {
                    // num_evals
                } {
                ...
                if mload(0x01e0) {
                    let num_limbs := mload(0x0220)
                    let num_limb_bits := mload(0x0240)
            ...
            // Compute lagrange evaluations and instance evaluation
            {
                ...
                let mptr := x_n_mptr
                let num_instances := mload(0xe0)
                let num_neg_lagranges := mload(0x0480)
                let mptr_end := add(
                    mptr,
                    mul(0x20, add(num_instances, num_neg_lagranges))
                )
                if iszero(num_instances) {
                    mptr_end := add(mptr_end, 0x20)
                }
                for {
                    let pow_of_omega := mload(0x01c0)
                } lt(mptr, mptr_end) {
                    mptr := add(mptr, 0x20)
                } {
                ...
                mptr := x_n_mptr
                let l_i_common := mulmod(x_n_minus_1, mload(0x0160), R)
                for {
                    let pow_of_omega := mload(0x01c0)
                } lt(mptr, mptr_end) {
                    mptr := add(mptr, 0x20)
                ...
                for {
                    let l_i_cptr_end := add(
                        x_n_mptr,
                        mul(0x20, num_neg_lagranges)
                    )
            ...
            // Compute quotient evaluation
            {
                ...
                let y := mload(add(theta_mptr, 0x60))
                {
                    ...
                    for {
                        let code_block := 0
                    } lt(code_block, computations_len) {
                        code_block := add(code_block, 0x20)
                    } {
                ...
                }
                {
                    ...
                    let permutation_z_evals_ptr := mload(0x0400)
                        ...
                        let eval := addmod(
                            ...
                            sub(
                                ...
                                mulmod(
                                    l_0,
                                    calldataload(
                                        and(permutation_z_evals, PTR_BITMASK)
                                    ),
                                    R
                                )
                            ),
...

                    {
                        ...
                        let perm_z_last_ptr := add(
                            mul(last_idx, and(num_words, PTR_BITMASK)),
                            permutation_z_evals_ptr
                        )
                        let perm_z_last := calldataload(
                            and(mload(perm_z_last_ptr), PTR_BITMASK)
                        )
                        quotient_eval_numer := addmod(
                            mulmod(quotient_eval_numer, y, R),
                            mulmod(
                        ...
                        mstore(
                            vka_end,
                            mulmod(
                                mload(add(theta_mptr, 0x20)),
                                mload(add(theta_mptr, 0x80)),
                                R
                            )
                        )
                ...
                }
                {
                    ...
                    let evals_ptr, meta_data := soa_layout_metadata(0x0420)
            ...
            // Compute quotient commitment
            {
                ...
                mstore(
                    add(0x20, vka_end),
                    calldataload(add(mload(0x03a0), 0x20))
                )
            ...
            // Compute pairing lhs and rhs
            {
                ...
                let pcs_ptr := mload(0x0440)
                {
                    ...
                    // Store interm point
                    mstore(
                        add(and(point_computations, PTR_BITMASK), vka_end),
                        x
                    )
                ...
                // vanishing_computations
                {
                    ...
                    for {
                        ...
                        mstore(
                            ...
                            addmod(
                                mu,
                                sub(R, mload(add(point_mptr, vka_end))),
                                R
                            )
                        )
                    }
                    ...
                    let s := mload(
                        add(vka_end, and(vanishing_computations, PTR_BITMASK))
                    )
                    vanishing_computations := shr(16, vanishing_computations)
                    for {
                        let i
                        ...
                        for {
                            ...
                            s := mulmod(
                                ...
                                mload(
                                    add(
                                        vka_end,
                                        and(vanishing_computations, PTR_BITMASK)
                                    )
                                ),
                                R
                            )
                ...
                // coeff_computations
                {
                    ...
                    let end_ptr_packed_lens := add(
                        pcs_ptr,
                        mul(0x20, and(coeff_len_data, BYTE_FLAG_BITMASK))
                    )
                    ...
                    for {
                        ...
                        for {
                            ...
                            coeff_len_data := coeff_computations(
                                coeff_len_data,
                                mload(pcs_ptr)
                            )
                            pcs_ptr := add(pcs_ptr, 0x20)
                ...
                // normalized_coeff_computations
                {
                    ...
                    success := batch_invert(
                        success,
                        vka_end,
                        add(and(norm_coeff_data, PTR_BITMASK), vka_end)
                    )
                    ...
                    for {
                        ...
                        let mptr_end := add(
                            mptr0,
                            and(norm_coeff_data, PTR_BITMASK)
                        )
                    } lt(mptr, mptr_end) {
                        mptr := add(mptr, 0x20)
                    } {
                ...
                // r_evals_computations
                {
                    ...
                    let end_ptr_packed_lens := add(
                        pcs_ptr,
                        mul(0x20, and(r_evals_meta_data, BYTE_FLAG_BITMASK))
                    )
                    r_evals_meta_data := shr(8, r_evals_meta_data)
                    let set_coeff := add(
                        and(r_evals_meta_data, PTR_BITMASK),
                        vka_end
                    )
                    ...
                    for {
                        ...
                        for {
                            ...
                            r_eval, pcs_ptr := r_evals_computation(
                                and(r_evals_meta_data, BYTE_FLAG_BITMASK),
                                pcs_ptr,
                                zeta,
                                quotient_eval,
                                coeff_ptr
                ...
                // coeff_sums_computation
                {
                    ...
                    let end_ptr_packed_lens := add(
                        pcs_ptr,
                        mul(0x20, and(coeff_sums_data, BYTE_FLAG_BITMASK))
                    )
                    ...
                    for {
                        ...
                        for {
                            ...
                            mstore(
                                add(and(coeff_sums_data, PTR_BITMASK), vka_end),
                                sum
                            )
                ...
                let nu := mload(add(theta_mptr, 0xC0))
                {
                    ...
                    let end_ptr_packed_lens := add(
                        ...
                        mul(
                            0x20,
                            and(pairing_input_meta_data, BYTE_FLAG_BITMASK)
                        )
                    )
                    pairing_input_meta_data := shr(8, pairing_input_meta_data)
                    let set_coeff := add(
                        and(pairing_input_meta_data, PTR_BITMASK),
                        vka_end
                    )
                    pairing_input_meta_data := shr(16, pairing_input_meta_data)
                    let ec_points_cptr_packed := and(
                        pairing_input_meta_data,
                    ...
                    for {
                        ...
                        for {
                            ...
                            pairing_input_meta_data := shr(
                                8,
                                pairing_input_meta_data
                            )
                            if first {
                                first := 0
                                success := pairing_input_computations_first(
                                    len,
                                    pcs_ptr,
                                    mload(pcs_ptr),
                                    theta_mptr,
                            ...
                            success := pairing_input_computations(
                                len,
                                pcs_ptr,
                                mload(pcs_ptr),
                                theta_mptr,
                            ...
                            success := ec_mul_tmp(
                                success,
                                mulmod(nu, mload(set_coeff), R)
                            )
                            set_coeff := add(set_coeff, 0x20)
                            success := ec_add_acc(
                                success,
                                mload(add(0x80, vka_end)),
                                mload(add(0xa0, vka_end))
                            )
                    ...
                    success := ec_mul_tmp(
                        success,
                        sub(R, mload(add(theta_mptr, 0x2A0)))
                    )
                    success := ec_add_acc(
                        success,
                        mload(add(0x80, vka_end)),
                    ...
                    mstore(
                        add(0x80, vka_end),
                        calldataload(and(ec_points_cptr_packed, PTR_BITMASK))
                    )
                    ...
                    success := ec_mul_tmp(
                        ...
                        sub(
                            ...
                            mload(
                                add(
                                    and(ec_points_cptr_packed, PTR_BITMASK),
                                    vka_end
                                )
                            )
                        )
